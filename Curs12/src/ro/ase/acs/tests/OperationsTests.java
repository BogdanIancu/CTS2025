...
public class OperationsTests {
    ...
    public void additionConformanceTest() {
        Operations operations = new Operations();
        double result = operations.addition(1.3333, 2.6666);
        assertEquals("The sum is not conform", 4.00, result, 0.000009);
    }

    @Test
    public void additionOrderingTest() {
        Operations operations = new Operations();
    ...
    @Test
    public void additionReferenceTest() {
        Operations operations = new Operations();
        double[] values = null;
        double result = operations.addition(values);

        assertEquals("The result should be 0 for null array", 0, result, 0.009);
    }

    @Test
    public void additionExistenceTest() {
        Operations operations = new Operations();
    ...
    @Test
    public void additionCardinality1Test() {
        Operations operations = new Operations();
    ...
    @Test(timeout = 1)
    public void additionCardinalityNTest() {
        Operations operations = new Operations();
